...
public static class ArrayDimensions {
    ...
    extension(Array arr) {
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Size2D GetSize2D() => new(GetLen0(arr), GetLen1(arr));
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Size3D GetSize3D() => new(GetLen0(arr), GetLen1(arr), GetLen2(arr));
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Size4D GetSize4D() => new(GetLen0(arr), GetLen1(arr), GetLen2(arr), GetLen3(arr));
    }
}