...
/// </summary>
public readonly record struct Rect4D : IFormattable {
    ...
    public Rect4D(int lowerW, int lowerX, int lowerY, int lowerZ, int higherW, int higherX, int higherY, int higherZ) {
    ...
    public Rect4D(Point4D lower, Point4D higher) {
    ...
    public Rect4D(Point4D lower, Size4D s) {
    ...
    public static Rect4D operator +(Rect4D area, Size4D size) => new(area.Lower, area.Size + size);
    public static Rect4D operator -(Rect4D area, Size4D size) => new(area.Lower, area.Size - size);

    public static Rect4D operator +(Rect4D area, Point4D point) => new(area.Lower + point, area.Higher + point);
    public static Rect4D operator -(Rect4D area, Point4D point) => new(area.Lower - point, area.Higher - point);
