...
public readonly record struct Size4D {
    ...
    /// </returns>
    public static Size4D Max(Size4D a, Size4D b) => new(Math.Max(a.W, b.W), Math.Max(a.X, b.X), Math.Max(a.Y, b.Y), Math.Max(a.Z, b.Z));
    ...
    ///     from the two input sizes.
    /// </returns>
    public static Size4D Min(Size4D a, Size4D b) => new(Math.Min(a.W, b.W), Math.Min(a.X, b.X), Math.Min(a.Y, b.Y), Math.Min(a.Z, b.Z));
}