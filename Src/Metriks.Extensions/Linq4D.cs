...
public static class Linq4DExtensions {
    extension<T>(IEnumerable4D<T> list) {
        ...
        /// <summary>
        /// Returns the first element of the four-dimensional enumerable, or a default value if the sequence contains no elements.
        /// </summary>
        public T? FirstOrDefault() => list.Flatten().FirstOrDefault();

        /// <summary>
        /// Returns the first element of the four-dimensional enumerable that satisfies a condition or a default value if no such element is found.
        /// </summary>
        ...
        /// <summary>
        /// Returns the last element of the four-dimensional enumerable, or a default value if the sequence contains no elements.
        /// </summary>
        public T? LastOrDefault() => list.Flatten().LastOrDefault();

        /// <summary>
        /// Returns the last element of the four-dimensional enumerable that satisfies a condition or a default value if no such element is found.
        /// </summary>
        public T? LastOrDefault(Func<T, bool> predicate) => list.Flatten().LastOrDefault(predicate);

        /// <summary>
        /// Returns the only element of the four-dimensional enumerable, and throws an exception if there is not exactly one element in the sequence.
        /// </summary>
        public T Single() => list.Flatten().Single();

        /// <summary>
        /// Returns the only element of the four-dimensional enumerable that satisfies a specified condition, and throws an exception if more than one such element exists.
        /// </summary>
        public T Single(Func<T, bool> predicate) => list.Flatten().Single(predicate);

        /// <summary>
        /// Returns the only element of the four-dimensional enumerable, or a default value if the sequence is empty; this method throws an exception if there is more than one element in the sequence.
        /// </summary>
        public T? SingleOrDefault() => list.Flatten().SingleOrDefault();

        /// <summary>
        /// Returns the only element of the four-dimensional enumerable that satisfies a specified condition or a default value if no such element exists; this method throws an exception if more than one element satisfies the condition.
        /// </summary>
